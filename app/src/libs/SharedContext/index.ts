...
>(
  ...
  Selector extends SelectorKey<Service>
    ? Service['state']['context'][Selector]
    : Selector extends SelectorFunction<Service>
    ? ReturnType<Selector>
    : never
> {
...
type SelectorKey<Service extends Interpreter<any>> =
  keyof Service['state']['context'];

type SelectorFunction<Service extends Interpreter<any>> = (
  state: Service['state']
) => any;
